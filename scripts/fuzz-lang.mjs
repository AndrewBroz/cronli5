...
// corpus and round-trip review's job. Read the sampled output shapes to
// confirm the non-throwing outputs are not fudged.
//
...
const FORMS = {
  ...
  minute: ['0', '5', '30', '*/15', '*/45', '*/25', '5/15', '3/2', '*/7', '0-30',
    '5,10,30', '*'],
  hour: ['0', '9', '12', '9-17', '9,17', '*/2', '*/5', '1/2', '2/6', '9-17/2',
    '9-20,22', '*'],
  date: ['1', '15', '31', '1,15', '1-5', '*/2', 'L', '15W', 'LW', '*'],
