...
// 'de lunes a viernes a las 9:30 de la mañana'

cronli5('0 0 25 12 *', {lang: es});
// 'el 25 de diciembre a medianoche'
```
...
before `y` in enumerations, `del`/`al` contractions in ranges, and
12-hour times with day periods (`de la madrugada` 1–5, `de la mañana`
6–11, `de la tarde` 12–19, `de la noche` 20–24).

## Conventions worth knowing

* Article agreement: `a la 1` but `a las 2` — singular one o'clock takes
  the singular article.
* Exact 12:00 reads as words: `al mediodía`, `a medianoche`.
...
* Where English says "during the 9 a.m. and 5 p.m. hours", Spanish
  re-strategizes into per-hour windows: `de las 9 a las 9:59 de la
  mañana y de las 5 a las 5:59 de la tarde`.

## Dialects

The default `es` style uses the panhispanic colon separator (`9:30`).
...
Spanish-specific grammar (the singular `a la 1` article, the `sábados`
plural).
...
| `0 0 * * *` | todos los días a medianoche | A las 00:00 |
| `30 9 * * MON-FRI` | de lunes a viernes a las 9:30 de la mañana | A las 09:30, de lunes a viernes |
| `0 9,17 * * *` | todos los días a las 9 de la mañana y a las 5 de la tarde | A las 09:00 y 17:00 |
| `0 22-2 * * *` | cada hora de las 10 de la noche a las 2 de la madrugada | Cada hora, entre las 22:00 y las 02:00 |
| `*/15 9-17 * * *` | cada 15 minutos de las 9 de la mañana a las 5:45 de la tarde | Cada 15 minutos, entre las 09:00 y las 17:59 |
| `0 0 1,15 * *` | los días 1 y 15 de cada mes a medianoche | A las 00:00, el día 1 y 15 del mes |
| `0 12 1 1 *` | el 1 de enero al mediodía | A las 12:00, el día 1 del mes, sólo en enero |
| `0 12 * 11-2 *` | todos los días de noviembre a febrero al mediodía | A las 12:00, de noviembre a febrero |
| `0 0 * * 5L` | el último viernes del mes a medianoche | A las 00:00, en el último viernes del mes |
| `5,10 30 9 * * MON` | en los segundos 5 y 10 de cada minuto, todos los lunes a las 9:30 de la mañana | A los 5 y 10 segundos del minuto, a los 30 minutos de la hora, a las 09:00, sólo el lunes |
| `1/1 * * * *` | cada minuto del 1 al 59 de cada hora | Cada 1 minutos, comenzando a los 1 minutos de la hora |
| `0 13 * * *` | todos los días a la 1 de la tarde | A las 13:00 |
| `0 12 * * SAT` | todos los sábados al mediodía | A las 12:00, sólo el sábado |
