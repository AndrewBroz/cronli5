...
wrap-around ranges into concrete times, normalizes unsorted input, collapses
degenerate shapes, and renders cron's day-of-month *or* day-of-week
semantics as "or". Fragment assembly handles the same inputs, but the seams
show: stacked comma clauses, grammatical slips ("1 minutes"), and an "and"
where cron fires on *either*.
...
| `*/15 30 9-17 * * MON-FRI` | every 15 seconds, at 30 minutes past the hour from 9:00 AM through 5:30 PM on Monday-Friday | Every 15 seconds, at 30 minutes past the hour, between 09:00 AM and 05:59 PM, Monday through Friday |
...
| `* 9,12,17 * * MON-FRI` | every minute during the 9:00 AM, 12:00 PM and 5:00 PM hours on Monday-Friday | Every minute, at 09:00 AM, 12:00 PM, and 05:00 PM, Monday through Friday |
