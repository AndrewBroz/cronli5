...
describe('Suomi (fi):', function() {
  ...
  describe('ankkuroidut minuutit ja sekunnit', function() {
    run([
      ['30 * * * *', 'jokaisen tunnin minuutilla 30'],
      ['0,30 * * * *', 'jokaisen tunnin minuuteilla 0 ja 30'],
      ['0-29 * * * *', 'jokaisen tunnin minuuteilla 0–29'],
      ['5-10,20 * * * *', 'jokaisen tunnin minuuteilla 5–10 ja 20'],
      ['5,30-40/5 * * * *',
        'jokaisen tunnin minuuteilla 5, 30, 35 ja 40'],
      ['*/31 * * * *', 'jokaisen tunnin minuuteilla 0 ja 31'],
      ['*/17 * * * *', '17 minuutin välein tasatunnista alkaen'],
      ['1/3 * * * *',
        'kolmen minuutin välein jokaisen tunnin minuutista 1 alkaen'],
      ['15 * * * * *', 'jokaisen minuutin sekunnilla 15'],
      ['0,30 * * * * *', 'jokaisen minuutin sekunneilla 0 ja 30'],
      ['0-30 * * * * *', 'jokaisen minuutin sekunneilla 0–30'],
      ['15 30 * * * *', 'jokaisen tunnin minuutilla 30 ja sekunnilla 15'],
      ['*/15 30 * * * *',
        '15 sekunnin välein jokaisen tunnin minuutilla 30'],
  ...
  describe('yhdistelmät', function() {
    run([
      ...
      ['30 9-17 * * *', 'jokaisen tunnin minuutilla 30 klo 9.30–17.30'],
      ['*/15 9,17 * * *',
      ...
      ['0-30 9,17 * * *', 'minuuteilla 0–30 klo 9 ja 17'],
      ['0-30 */2 * * *', 'minuuteilla 0–30 joka toinen tunti'],
      ...
      ['0,30 8-18/2 * * *',
        'jokaisen tunnin minuuteilla 0 ja 30, klo 8, 10, 12, 14, 16 ' +
        'ja 18'],
      ['*/15 30 9 * * *', '15 sekunnin välein, joka päivä klo 9.30'],
      ['1 1 * * * *', 'jokaisen tunnin minuutilla 1 ja sekunnilla 1'],
  ...
  describe('harvinaiset muodot', function() {
    run([
      ...
      ['5 0,30 * * * *',
        'jokaisen minuutin sekunnilla 5, ' +
        'jokaisen tunnin minuuteilla 0 ja 30'],
      ['30-40/5 * * * * *', 'jokaisen minuutin sekunneilla 30, 35 ja 40'],
      ['40/15 * * * *', 'jokaisen tunnin minuuteilla 40 ja 55'],
      ['* 9-17 * * *', 'joka minuutti klo 9.00–17.59'],
      ['0-30 9-17 * * *', 'minuuteilla 0–30 klo 9.00–17.30'],
      ['0,30 9-17 * * *',
        'jokaisen tunnin minuuteilla 0 ja 30 klo 9.00–17.30'],
      ['0 9-17/2 * * *', 'klo 9, 11, 13, 15 ja 17'],
      ['0-30 1/6 * * *',
        'minuuteilla 0–30, kuuden tunnin välein klo 1 alkaen'],
      ['* 8-18,22 * * *',
        'joka minuutti klo 8.00–18.59 ja 22.00–22.59'],
      ['5-10 1,3,5,7,9,11,13 * * *',
        'minuuteilla 5–10 klo 1, 3, 5, 7, 9, 11 ja 13'],
