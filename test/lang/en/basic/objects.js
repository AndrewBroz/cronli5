...
describe('Common objects:', function() {
  var tests = [
    ...
    [{hour: '12'}, 'every day at noon'],
    [{hour: '0'}, 'every day at midnight'],
    [{hour: '7'}, 'every day at 7 a.m.'],
    [{hour: '13', weekday: 'FRI'}, 'every Friday at 1 p.m.'],
    [{hour: '2', weekday: 'MON-FRI'}, 'every Monday through Friday at 2 a.m.'],
    [{hour: '15', weekday: 'TUE'}, 'every Tuesday at 3 p.m.'],
    [{hour: '14', weekday: 'MON,WED,FRI'}, 'every Monday, Wednesday, and Friday at 2 p.m.'],
    [{hour: '23', weekday: 'THU'}, 'every Thursday at 11 p.m.'],
    [{hour: '6', weekday: 'SAT'}, 'every Saturday at 6 a.m.'],
    [{hour: '13', weekday: '5'}, 'every Friday at 1 p.m.'],
    [{hour: '2', weekday: '1-5'}, 'every Monday through Friday at 2 a.m.'],
    [{hour: '15', weekday: '2'}, 'every Tuesday at 3 p.m.'],
    [{hour: '14', weekday: '1,3,5'}, 'every Monday, Wednesday, and Friday at 2 p.m.'],
    [{hour: '23', weekday: '4'}, 'every Thursday at 11 p.m.'],
    [{hour: '6', weekday: '6'}, 'every Saturday at 6 a.m.']
  ];
