...
// minute folds into per-segment windows ("9:30 a.m. through 8:30 p.m."), and a
...
describe('Clock-time enumeration cap:', function() {
  ...
  describe('a single minute folds into segment windows', function() {
    run([
      ['0 9-20,22 * * *',
        'every day at 9 a.m. through 8 p.m. and 10 p.m.'],
      ['30 9-20,22 * * *',
        'every day at 9:30 a.m. through 8:30 p.m. and 10:30 p.m.'],
      ['30 12,20-2 * * *',
        'every day at 12:30 p.m. and 8:30 p.m. through 2:30 a.m.']
    ]);
  });
