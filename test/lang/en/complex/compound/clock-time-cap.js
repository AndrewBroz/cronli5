...
// frame ("every hour from 9 a.m. until 9 p.m. and at 10 p.m."), and a
...
describe('Clock-time enumeration cap:', function() {
  ...
  describe('a single minute folds into segment windows', function() {
    run([
      ['0 9-20,22 * * *',
        'every hour from 9 a.m. until 9 p.m. and at 10 p.m.'],
      ['30 9-20,22 * * *',
        'at 30 minutes past the hour from 9 a.m. until 9 p.m. and at 10:30 p.m.'],
      ['30 12,20-2 * * *',
        'at 30 minutes past the hour from 8 p.m. until 3 a.m. and at 12:30 p.m.']
    ]);
  });
