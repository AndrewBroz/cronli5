...
describe('Valid strings with lists:', function() {
  ...
  describe('hour lists', function() {
    run([
      ...
      ['0 9,12,17 * * *', 'every day at 9:00 AM, 12:00 PM and 5:00 PM']
    ]);
  });
  ...
  describe('date lists', function() {
    run([
      ...
      ['0 0 1,15,31 * *', 'on the 1st, 15th and 31st at 12:00 AM']
    ]);
  });

  describe('month lists', function() {
    run([
      ['0 12 * 6,12 *', 'every day in June and December at 12:00 PM'],
      [
        '0 12 * 1,4,7,10 *',
        'every day in January, April, July and October at 12:00 PM'
      ],
      ['0 12 * JAN,JUL *', 'every day in January and July at 12:00 PM']
    ]);
  });
