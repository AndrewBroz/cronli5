...
describe('Common arrays:', function() {
  describe('5-part arrays', function() {
    run([
      ...
      [['0', '2', '*', '*', 'MON-FRI'], 'every Monday through Friday at 2:00 AM'],
      ...
      [['0', '2', '*', '*', '1-5'], 'every Monday through Friday at 2:00 AM'],
  ...
  describe('6-part arrays', function() {
    run([
      ...
      [['0', '0', '2', '*', '*', 'MON-FRI'], 'every Monday through Friday at 2:00 AM'],
      ...
      [['0', '0', '2', '*', '*', '1-5'], 'every Monday through Friday at 2:00 AM'],
